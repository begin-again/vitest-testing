...
import {deepMerge, greeting, loadConfig, getCurrentTime, warnLater} from '../index';
...
describe('Deep Merge', () =>{
    ...
    test('deep merge with overlaps', () => {
        const a = {name: 'todd', accounts:{github:'unknown'},
            languages: ['javascript']
        };
        const b = {accounts: {twitter: 'abc'}, languages: ['typescript', 'vue']};
    ...
    test('throws an error on merging two different types', () => {
        ...
        expect(() => deepMerge(a,b) ).toThrowError('Can not merge two different types');
    });
